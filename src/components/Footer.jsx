...
export function Footer() {
  ...
  const readGameVersion = async (installedDir) => {
  ...
  return (
    <footer>
      <div class='footerContainer'>
        <a href='https://discord.gg/Hpe657nmGu'>
          <span>
            <svg
              role='img'
              viewBox='0 0 24 24'
        ...
        <a href='https://gitlab.com/Grahf0085/atavismxiwebsite'>
          <span>
            <Gitlab /> Website
          </span>
        </a>
        <a href='https://gitlab.com/Grahf0085/AtavismXI'>
          <span>
            <Gitlab /> Server
          </span>
        </a>
